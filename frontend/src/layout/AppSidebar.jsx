...
export function AppSidebar() {
    ...
    // --- Lấy thông tin vai trò và chức vụ người dùng ---
            ...
            items: [
...

                {
                    ...
                    subItems: [
                        ...
                        ...(user?.vaitro?.TEN_VAITRO === 'Giảng viên' ? [
                            { href: "/lecturer/groups-management", title: "Quản lý nhóm" },
                        ] : []),
                    ],
                }
            ]
    ...
    return (
        <Sidebar collapsible="icon" className="group">
            ...
            <SidebarContent className="py-3">
                ...
                {/* Menu Quản trị chỉ hiện nếu là admin, giáo vụ, trưởng khoa */}

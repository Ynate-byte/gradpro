    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogContent className="sm:max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription>
            Bạn có thể tạo mới từ đầu hoặc sử dụng một bản mẫu có sẵn để tiết kiệm thời gian.
          </DialogDescription>
        </DialogHeader>
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Bắt đầu với một biểu mẫu trống và tự điền tất cả thông tin.
              </p>
            </div>
          </Button>
          <h4 className="text-sm font-medium text-muted-foreground pt-2">
            Hoặc sử dụng một bản mẫu có sẵn:
          </h4>
          {isLoading ? (

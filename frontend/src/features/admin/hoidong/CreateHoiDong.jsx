...
// [SỬA] Bỏ CardHeader, CardTitle, Card, CardDescription
...
import { ScrollArea } from "@/components/ui/scroll-area"; // Giữ lại cho cuộn nội bộ
...
// [SỬA] Đổi tên component và export
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogContent className="max-w-4xl max-h-[90vh] flex flex-col p-0">
        ...
        {/* [START SỬA LỖI] */}
        {/* 1. Form trở thành khu vực cuộn chính */}
        <form
          id="create-hoidong-form"
          onSubmit={handleSubmit}
          className="flex-grow min-h-0 overflow-y-auto" // Thêm overflow-y-auto
        >
          {loading ? (
            ...
            // 2. Toàn bộ nội dung form nằm trong div p-6
            <div className="p-6 space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                {isManual && (
                  <div className="space-y-2">
                    <Label htmlFor="TEN_HOIDONG-dialog">
                      Tên hội đồng (Tùy chọn)
                    </Label>
                    <Input
                      type="text"
                      id="TEN_HOIDONG-dialog"
                      name="TEN_HOIDONG"
                ...
                <div className="space-y-2">
                  ...
                  >
                    <SelectTrigger id="ID_KEHOACH-dialog">
                ...
                <div className="space-y-2">
                  ...
                  >
                    <SelectTrigger id="ID_CHUYENNGANH-dialog">
                ...
                <div className="space-y-2">
                  <Label htmlFor="NGAY_BAOCAO-dialog">
                    Ngày báo cáo (Tùy chọn)
                  </Label>
                  <Input
                    type="date"
                    id="NGAY_BAOCAO-dialog"
                    name="NGAY_BAOCAO"
                ...
                <div className="space-y-2">
                  <Label htmlFor="GIO_BAOCAO-dialog">
                    Giờ báo cáo (Tùy chọn)
                  </Label>
                  <Input
                    type="time"
                    id="GIO_BAOCAO-dialog"
                    name="GIO_BAOCAO"
              ...
              {isManual && (
                <div className="mt-8 space-y-4 pt-4 border-t">
                  ...
                  {/* 3. Đây là "cuộn trong database" (giữ nguyên h-64) */}
                  <ScrollArea className="h-64 border rounded-md p-3 bg-muted/50">
                    {loadingGV ? (
                      ...
                      filteredGV.map((gv) => {
                        const isAssigned =
                          gv.HOIDONGS && gv.HOIDONGS.length > 0;
                        ...
                        return (
                          ...
                          >
                            <Label
                              htmlFor={`gv-dialog-${gv.ID_GIANGVIEN}`}
                              className={cn(
        ...
        {/* 4. Footer nằm ngoài form, là flex-shrink-0 */}
        <DialogFooter className="p-6 border-t flex-shrink-0">
          ...
          <Button
            type="submit"
            form="create-hoidong-form" // 5. Liên kết với form
            disabled={
              loading || isSubmitting || !form.ID_KEHOACH || !form.ID_CHUYENNGANH
            }

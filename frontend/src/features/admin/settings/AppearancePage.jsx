        ...
        <div className="max-w-5xl mx-auto space-y-10 py-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                    ...
                    <button
                        ...
                        className={cn(
                            ...
                            theme === "light" 
                                ? "border-primary bg-primary/5 ring-0" // Bỏ ring, chỉ dùng border
                    ...
                    >
                        <div className="w-full aspect-video rounded-lg bg-[#e2e8f0] border shadow-sm p-4 flex flex-col gap-3 overflow-hidden relative">
                            {/* Mô phỏng UI Sáng: Tăng độ đậm của nền xám để nổi bật trên nền trắng */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                ...
                <div className="space-y-4">
                    ...
                    {/* Thanh chọn font size được làm gọn lại */}
                        ...
                        {fontOptions.map((item, index) => (
                            <button
                                ...
                                className={cn(
                                    ...
                                    fontSize === item.value 
                                        ? "bg-background text-primary shadow-sm font-bold border border-border" // Đổi style active cho nhẹ nhàng hơn

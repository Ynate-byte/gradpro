...
export default function TemplateFormPage() {
  ...
  // Tải dữ liệu bản mẫu khi ở chế độ chỉnh sửa
  useEffect(() => {
  ...
  // Xử lý sự kiện khi kéo thả mốc thời gian
  ...
  // Gửi dữ liệu bản mẫu để tạo hoặc cập nhật
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
            ...
            <h1 className="text-3xl font-bold mt-2">
              {isEditMode ? 'Chỉnh sửa Bản mẫu' : 'Tạo Bản mẫu mới'}
            </h1>
            <p className="text-muted-foreground">
              Điền thông tin và các mốc thời gian tương đối cho bản mẫu.
            </p>
          </div>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="VD: KLTN Cử nhân" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}

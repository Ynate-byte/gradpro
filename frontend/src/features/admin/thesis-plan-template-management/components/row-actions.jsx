...
import { deleteAdminThesisPlanTemplate } from '@/api/thesisPlanService'

// Hiển thị các hành động cho mỗi hàng bản mẫu
        ...
        <AlertDialogContent aria-labelledby={deleteTitleId} aria-describedby={deleteDescriptionId}>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription id={deleteDescriptionId}>
              Hành động này không thể hoàn tác. Bạn có chắc chắn muốn xóa vĩnh viễn bản mẫu{" "}
              <strong>"{template.TEN_MAU}"</strong> không?
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>

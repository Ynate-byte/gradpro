import React, { useState, useEffect, useCallback } from 'react'; // Sửa đổi
import {
    Sheet,
    SheetContent,
    SheetHeader,
...
import { getSubmissions } from '@/api/groupService'; // Thêm
import { toast } from 'sonner'; // Thêm
import { Alert, AlertDescription } from "@/components/ui/alert"; // Thêm
...
// ----- BẮT ĐẦU KHỐI THÊM MỚI (Copy từ SubmissionArea) -----
/**
...
                        {/* Card danh sách thành viên (Giữ nguyên) */}
                        <Card className="border border-blue-200 dark:border-blue-700 shadow-md bg-white dark:bg-gray-800">
                            <CardHeader>
                                <CardTitle className="text-lg font-semibold text-gray-800 dark:text-gray-100 flex items-center gap-2">
...
                                            {/* ... (code hiển thị thành viên giữ nguyên) ... */}

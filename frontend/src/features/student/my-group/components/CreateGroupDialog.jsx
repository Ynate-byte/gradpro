...
// Định nghĩa schema validation cho form tạo nhóm
...
export function CreateGroupDialog({ isOpen, setIsOpen, onSuccess, planId }) {
    ...
    // Hook tải dữ liệu Chuyên ngành và Khoa/Bộ môn khi dialog mở
    useEffect(() => {
        if (isOpen) {
            form.reset();

...
import { BookCopy, AlertCircle } from 'lucide-react'; // <-- Thêm AlertCircle
...
export default function MyGroupPage() {
    ...
    if (!pageState.isLoading && pageState.activePlans.length === 0) {
        ...
        const isEligible = pageState.selectedPlan?.sinhvien_thamgias?.[0]?.DU_DIEUKIEN ?? true;

    // Hiển thị giao diện chính
    return (
        <div className="space-y-6 p-4 md:p-8"> {/* Thêm padding */}

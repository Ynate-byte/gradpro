...
const RegisteredGroupsDialog = ({ open, onOpenChange, topic }) => {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        className="max-w-3xl w-full h-[80vh] p-0 flex flex-col overflow-hidden bg-gray-50 dark:bg-gray-900 border-l-4 border-blue-500"
      >
        <div className="flex flex-col h-full overflow-hidden">
          ...
          {/* Scrollable Body using native div */}
          ...
          {/* Footer Fixed */}
          <div className="p-4 border-t bg-white dark:bg-gray-800 shrink-0 flex justify-end">
             <Button onClick={() => onOpenChange(false)} variant="outline">Đóng</Button>
          </div>

...
return new class extends Migration {
    public function up(): void {
        Schema::create('CONGVIEC', function (Blueprint $table) {
            ...
            $table->dateTime('NGAY_HETHAN')->nullable();
            ...
            $table->foreign('ID_COT')->references('ID_COT')->on('COT_CONGVIEC')->onDelete('cascade');
            $table->foreign('ID_NGUOITAO')->references('ID_NGUOIDUNG')->on('NGUOIDUNG')->onDelete('cascade');
        });
    }
    public function down(): void { Schema::dropIfExists('CONGVIEC'); }
};
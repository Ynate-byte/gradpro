...
return new class extends Migration {
    public function up(): void {
        Schema::create('DETAI', function (Blueprint $table) {
            ...
            $table->enum('TRANGTHAI', [
                'Nháp', 'Chờ duyệt', 'Yêu cầu chỉnh sửa', 'Đang chỉnh sửa', 
                'Đã duyệt', 'Đã đầy', 'Đã khóa', 'Từ chối'
            ])->default('Nháp');
            
            $table->boolean('LA_TAISUDUNG')->default(false);
    ...
    public function down(): void { Schema::dropIfExists('DETAI'); }
};
...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('NHOM', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('ID_NHOMTRUONG')->nullable()->comment('ID_NGUOIDUNG của nhóm trưởng');
            $table->unsignedBigInteger('ID_CHUYENNGANH')->nullable()->comment('FK đến CHUYENNGANH');
            $table->unsignedBigInteger('ID_KHOA_BOMON')->nullable()->comment('FK đến KHOA_BOMON');
            ...
            $table->enum('TRANGTHAI', ['Đang mở', 'Đã đủ thành viên', 'Đã có đề tài', 'Đang thực hiện', 'Đã hoàn thành'])
                ->default('Đang mở');
        ...
        Schema::create('THANHVIEN_NHOM', function (Blueprint $table) {
            ...
            $table->unique(['ID_NHOM', 'ID_NGUOIDUNG'], 'UQ_MOT_SINHVIEN_MOT_NHOM');
        ...
        Schema::create('YEUCAU_VAONHOM', function (Blueprint $table) {
            ...
            $table->foreign('ID_NHOM')->references('ID_NHOM')->on('NHOM')->cascadeOnDelete();
            $table->foreign('ID_NGUOIDUNG')->references('ID_NGUOIDUNG')->on('NGUOIDUNG')->cascadeOnDelete();
            $table->foreign('ID_NGUOI_PHANHOI')->references('ID_NGUOIDUNG')->on('NGUOIDUNG')->nullOnDelete();
        });
    }

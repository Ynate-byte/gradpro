...
return new class extends Migration {
    public function up(): void {
        Schema::create('PHANCONG_DETAI_NHOM', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('ID_GVHD');
            $table->timestamp('NGAY_PHANCONG')->nullable()->useCurrent();
            $table->enum('TRANGTHAI', ['Đang thực hiện', 'Đã hoàn thành', 'Không đạt'])->default('Đang thực hiện');
    ...
    public function down(): void { Schema::dropIfExists('PHANCONG_DETAI_NHOM'); }
};
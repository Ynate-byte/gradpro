...
{
    /**
     * Get lecturers in department for reviewer assignment
     */
    public function getLecturers(Request $request)
    {
        ...
        $result = $lecturers->map(function($lecturer) {
            return [
                ...
                'TEN_GIANGVIEN' => $lecturer->nguoidung->HODEM_VA_TEN ?? 'N/A',
                'EMAIL' => $lecturer->nguoidung->EMAIL ?? 'N/A',
                'HOCVI' => $lecturer->HOCVI ?? 'N/A',
                'CHUCVU' => $lecturer->CHUCVU ?? 'N/A',
                'CHUYENMON' => $lecturer->CHUYENMON ?? 'N/A',
            ];
        });
    ...
    public function getTopicsForReviewers(Request $request)
    {
        ...
        // Get draft/pending topics from the department head's department in the plan
    ...
    /**
     * Assign reviewers to topics (Override to remove topic department check)
     */
